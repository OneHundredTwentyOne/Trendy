...
router.post('/', function (req,res,next) {
  ...
  pg.connect(database,function(err,client,done){
    ...
    var query = ("INSERT INTO Cart (sellername,image,label,size,price, username) VALUES ($1, $2, $3, $4, $5, $6)");
    client.query(query,[sellername,image,label,size,price,username], function(error, result){
